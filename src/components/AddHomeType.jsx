...
function AddHomeType({ navigation }) {
  const backpress = () => {
    navigation.goBack();
  };
  return (
    <View style={{ height: "100%" }}>
      ...
      <Header back={true} title={"Add Home Type"} nav={backpress} />
          ...
          <View style={styles.cardStyle}>
            <View style={styles.cardContentStyle}>
              <View style={styles.headingContainer}>
                <Text style={styles.headingTxt}>Home Type</Text>
                <Text style={styles.headingAstriskTxt}>*</Text>
              </View>

              <View style={styles.inputContainer}>
                <TextInput style={styles.txtInputStyle} placeholder="Name" />
              </View>
            </View>
          </View>
